...
RSpec.describe 'Basic Enumerable Exercises' do
  ...
  describe 'find word length exercise' do
    it 'returns a hash with rocket syntax when using strings' do
      ...
      animals = %w[cat cat cat horse horse horse horse horse rabbit rabbit rabbit
                   rabbit rabbit rabbit deer deer deer deer]
    ...
    it 'returns a hash with symbols syntax when using symbols' do
      ...
      animals = %i[cat cat cat horse horse horse horse horse rabbit rabbit rabbit rabbit
                   rabbit rabbit deer deer deer deer]
